...
const timeFormatter = d3.timeFormatLocale(localeDef);
const timeFormat = timeFormatter.format(localeDef.date);
 */
...
function update() {
	...
	// Update y-axis label
	const newText = (yValue === "price_usd") ? "Preço ($)" 
		: (yValue === "market_cap") ? "Capitalização de Mercado ($)" 
